...
function App() {
  ...
  const { jwtToken: clientJwtToken } = useAuthStore();
  const { jwtToken: adminJwtToken } = useAdminAuthStore();
              ...
              <Routes>
                  ...
                  <Route path="/user/chat" element={(
                    <ProtectedRoute>
                      <StompSessionProvider
                        ...
                        connectHeaders={clientJwtToken ? { Authorization: `Bearer ${clientJwtToken}` } : {}}
                      >
                        <ClientChat />
                      </StompSessionProvider>
                    </ProtectedRoute>
                ...
                <Route path="/admin" element={<Admin />}>
                  ...
                  <Route path={ManagerPath.CHAT} element={
                    <StompSessionProvider
                      url={ApplicationConstants.WEBSOCKET_PATH}
                      connectHeaders={adminJwtToken ? { Authorization: `Bearer ${adminJwtToken}` } : {}}
                    >
                      <ChatDashboard />
                    </StompSessionProvider>
                  } />
